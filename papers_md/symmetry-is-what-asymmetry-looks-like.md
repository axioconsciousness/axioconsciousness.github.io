...
Things that appear stable are doing work to remain stable. The stability is the trace of the work, not the absence of activity. A mountain appearing fixed is geological forces in dynamic equilibrium. A species appearing constant across generations is selective pressure operating consistently. A government appearing stable is institutional work sustaining the appearance.

Things that appear in equilibrium are not at rest. They are sustained by ongoing asymmetric processes maintaining the appearance. Equilibrium is a verb, not a state.

Things that appear symmetric were never symmetric. They are asymmetric processes operating regularly enough to look balanced.
